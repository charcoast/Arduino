...
#define LEDVerde 5    //Define LEDVerde
#define LEDVermelho 6 //Define LEDVermelho
#define buzzer 7      //Define buzzer

#define Echo 10       //Define Echo
#define Trigger 11    //Define Trigger
